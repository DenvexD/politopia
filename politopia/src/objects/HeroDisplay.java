...
public class HeroDisplay extends Display {
    ...
    if (this.actions != null) {
        ...
        for (DisplayActions action : this.actions) {
            switch (action) {
                case clearForest:
                    ActionButton cutForest = new ActionButton(this.x + currX, this.y, this.height, clearForsetImg, DisplayActions.clearForest);
                    this.actionButtons.add(cutForest);
                    break;
            
                case growForest:
                    ActionButton growForest = new ActionButton(this.x + currX, this.y, this.height, growForestImg, DisplayActions.growForest);
